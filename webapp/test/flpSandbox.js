		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#compoctreetablepoc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"compoctreetablepoc-display": {
								"semanticObject": "compoctreetablepoc",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.poc.treetablepoc",
									"url": sap.ui.require.toUrl("com/poc/treetablepoc")
								}
							}
						}
					}
